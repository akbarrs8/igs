...
$email = "rs8".rand(000000,9999999)."@gmail.com"; /// Edit Sama email Lo
$username = "rs8_".rand(000000,9999999);  /// Edit Username yg u inginkan
#$password = $username.randd();
$password = "545898355";  /// Edit password yg u inginkan
